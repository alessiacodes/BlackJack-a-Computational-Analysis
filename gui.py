...
Module Description
===============================
Turning our code into a data set using interactive features so anyone looking at our
...
def launch_gui() -> None:
    ...
    def get_necessary_inputs() -> None:
        ...
        if which_version_of_tree.get() == "Basic Pie Chart":
            ...
            dual_one()
        elif which_version_of_tree.get() == "Example Tree-Graph Structure":
            something_to_cover()

            def example_graph() -> None:
                """Showcase the example graph structure with a small tree value"""
                probability_tree.run_draw()
...
if __name__ == '__main__':
    ...
    python_ta.check_all(config={
        'extra-imports': ['stats', 'tkinter', 'probability_tree'],  # the names (strs) of imported modules
