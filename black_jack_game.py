...
Module Description
===============================
This module contains all code to run the Black Jack game
...
class Card:
    ...
    def __init__(self, name: str, value: int, suit: str) -> None:
        """Initialize card class with with the name-value of the card, the numerical value of the card, and the suit
        of the card"""
        self.name = name
        self.value = value
        self.suit = suit
...
class BlackJack:
    ...
    def handle_player_turn(self, target: int) -> None:
    ...
    def handle_end_game(self, target: int) -> str:
        ...
        elif self.player.sum_cards > target:
            return 'Dealer Wins'
...
if __name__ == '__main__':
    ...
    python_ta.check_all(config={
        'extra-imports': ['annotations', 'Optional', 'random', 'probability_tree'],
        'allowed-io': [],
        'max-line-length': 120,
        'disable': ['invalid-name', 'unnecessary-pass']
    })
